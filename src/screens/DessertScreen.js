...
class DessertScreen extends React.Component {
  ...
  openErstellenScreen(){
    ...
    this.props.navigation.navigate('Erstellen', {type: "DESSERT"})
  }
      ...
      <View style={[styles.kategorien,{flex:1}]}>
        ...
        <FlatList
          ...
          <TouchableOpacity style={styles.items} onPress={() =>{ 
            this.props.selectItem("SELECT_DESSERT", item.key)
            this.props.navigation.navigate('Detail',{type: "DESSERT"})} }>
...
export default connect(mapStateToProps, mapDispatchToProps)(DessertScreen);
