...
class BackwarenScreen extends React.Component {
  ...
  openErstellenScreen(){
    ...
    this.props.navigation.navigate('Erstellen', {type: "BACKWARE"})
  }
      ...
      <View style={[styles.kategorien,{flex:1}]}>
        ...
        <FlatList
          ...
          <TouchableOpacity style={styles.items} onPress={() =>{ 
            this.props.selectItem("SELECT_BACKWARE", item.key)
            this.props.navigation.navigate('Detail',{type: "BACKWARE"})} }>
...
const mapStateToProps = state => {
  return {
    items: state.backwaren.backwaren,
  }
}
...
export default connect(mapStateToProps, mapDispatchToProps)(BackwarenScreen);